...
namespace Prova.Server.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Vaga = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValorTecnologias = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vagas_Tecnologias_TecnologiasID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VagasId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Candidato", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Candidato_Tecnologias_TecnologiasId",
                        column: x => x.TecnologiasId,
                        principalTable: "Tecnologias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Candidato_Vagas_VagasId",
                        column: x => x.VagasId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Candidato_TecnologiasId",
                table: "Candidato",
                column: "TecnologiasId");

            migrationBuilder.CreateIndex(
                name: "IX_Candidato_VagasId",
                table: "Candidato",
                column: "VagasId");
